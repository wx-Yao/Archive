...
# We select the prime from RFC3526 8192-bit (assigned id 18)
# And the generator is 2
raw_prime="""
...
def calculate_dh_secret(their_public, my_private):
    ...
    # We think SHA256 and SHA512 are almost the same from a security perspective. Considering factors of performance, bandwidth consumpution, we choose to use SHA256 as is.
